	...
	<div class="mx-auto max-w-7xl px-6 lg:px-8">
		<div class="mx-auto max-w-2xl sm:text-center">
			...
			<p class="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
				You pay for each report that you generate.
			</p>
		</div>
		<div
			class="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 dark:ring-gray-600 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none"
		>
			<div class="p-8 sm:p-10 lg:flex-auto">
				<h3 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
					Cap Gains/Loss Report
				</h3>
				<div class="mt-10 flex items-center gap-x-4">
					<h4 class="flex-none text-sm font-semibold leading-6 text-indigo-600">Includes</h4>
					<div class="h-px flex-auto bg-gray-200 dark:bg-gray-600" />
				</div>
				<ul
					class="mt-8 grid grid-cols-1 gap-4 text-sm leading-6 text-gray-900 dark:text-gray-300 sm:grid-cols-2 sm:gap-6"
				>
			...
			<div class="-mt-2 p-2 lg:mt-0 lg:w-full lg:max-w-md lg:flex-shrink-0">
				...
				>
					<div class="mx-auto max-w-xs px-8">
						<p class="text-base font-semibold text-gray-900 dark:text-gray-300">Per report</p>
						<p class="mt-6 flex items-baseline justify-center gap-x-2">
							<span class="text-5xl font-bold tracking-tight text-gray-900 dark:text-white"
								>$TBD</span
							>
							<span
								class="text-sm font-semibold leading-6 tracking-wide text-gray-900 dark:text-gray-300"
								>USD</span
							>
						</p>
						<a
							...
							>Get Started</a
						>
						<p class="mt-6 text-xs leading-5 text-gray-900 dark:text-gray-300">
