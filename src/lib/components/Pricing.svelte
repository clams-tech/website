...
<div id="pricing" class="bg-gray-100 dark:bg-gray-900 py-24 sm:py-32">
	<div class="mx-auto max-w-5xl px-6 lg:px-8">
		...
		<div class="mt-8 md:mt-12 mx-auto max-w-5xl flex gap-4 justify-between flex-wrap">
			...
			<section
				class="p-8 w-full md:flex-1 rounded-xl bg-gray-400/5 ring-1 ring-inset ring-gray-200"
			>
