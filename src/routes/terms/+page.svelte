...
<ContentContainer title="Clams Terms of Service">
	...
	<section class="mb-6">
		...
		<p>
			...
			Clams or its content suppliers and are protected by copyright, trademark, and other
	...
	<section class="mb-6">
		...
		<p>
			...
			but not limited to, loss of profits, data, use, goodwill, or other intangible losses resulting
